        ...
        success: function (data) {
            ...
            if (data.code === 0) {
                ...
                if (data.list && data.list.order_state) {
                    ...
                    item += '<tr><td colspan="6" style="text-align:center"><div class="anran_kami_title">⬇️卡密信息⬇️</div></td><tr><td colspan="6">' + data.kminfo + '</td></tr>';
                    if (data.desc) {
                    item += '<tr><td colspan="6" style="text-align:center"><div class="anran_kami_title">商品简介</div></td><tr><td colspan="6" style="white-space: normal;" class="anran_kami_desc">' + data.desc + '</td></tr>';
                    }
                } else if (data.result) {
